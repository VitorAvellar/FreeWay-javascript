console.log("### p5.collide v0.7.3 ###"), p5.prototype._collideDebug = !1, p5.prototype.collideDebug = function (t) {
    ...
    var c = this.dist(t, o, e, i),
        p = this.dist(t, o, r, l),
        y = this.dist(e, i, r, l);
    return void 0 === n && (n = .1), c + p >= y - n && c + p <= y + n
    ...
    if (y >= 0 && y <= 1 && d >= 0 && d <= 1) {
        if (this._collideDebug || p) var u = t + y * (e - t),
            s = o + y * (i - o);
        return this._collideDebug && this.ellipse(u, s, 10, 10), !p || {
            x: u,
            y: s
        }
    }
    ...
    } : (y = this.collideLineLine(t, o, e, i, r, l, r, l + c), d = this.collideLineLine(t, o, e, i, r + n, l, r + n, l + c), u = this.collideLineLine(t, o, e, i, r, l, r + n, l), s = this.collideLineLine(t, o, e, i, r, l + c, r + n, l + c)), !!(y || d || u || s) && (!p || x)
    ...
    for (var n = 0, c = 0; c < r.length; c++) {
        ...
        if (!0 === l)
            if (this.collidePointPoly(t, o, r)) return !0
    }
    return !1
